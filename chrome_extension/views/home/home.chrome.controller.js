...
(function () {
  ...
  function homeController(scope,  $stateParams, $state, Authentication, Notes, activeTabUrl) {
    var self = this;
    self.authentication = {};
  ...
  angular.module('drops')
    .controller('homeController', ['$scope', '$stateParams', '$state', 'Authentication', 'Notes', 'activeTabUrl', homeController])
